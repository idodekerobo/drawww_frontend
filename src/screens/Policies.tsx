...
const ShippingHandling = () => {
   <Helmet>
      <title> Shipping & Handling Help | drawww</title>
      <meta name="description" content="Shipping and Handling Help page" />
...
const CustomerService = () => {
   return (
      <>
         <Helmet>
            <title>Contact Customer Service | drawww</title>
...
const ChargebackPolicy = () => {
   return (
      <>
         <Helmet>
            <title> Chargeback Policy | drawww</title>
            <meta name="description" content="Chargeback policy information" />
            <link rel="canonical" href={window.location.href} />
         </Helmet>
...
const ReturnPolicy = () => {
   return (
      <>
         <Helmet>
            <title>Return Policy | drawww</title>
            <meta name="description" content="Return policy information" />
            <link rel="canonical" href={window.location.href} />
         </Helmet>
         <h3>Return Policy</h3>
...
const PrivacyPolicy = () => {
   return (
      <>
         <Helmet>
            <title>Privacy Policy | drawww</title>
            <meta name="description" content="Privacy Policy information" />
            <link rel="canonical" href={window.location.href} />
         </Helmet>
